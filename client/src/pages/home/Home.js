  ...
  return (
    <div className={`home ${dark ? "home__dark" : ""}`}>
      ...
      <div className="home__intro2">
        ...
        <h1>AlgoEngine - Your DSA Companion!</h1>
        <p>
          At AlgoEngine, you get access to a powerful DSA search engine, tons of
          resources and many more. AlgoEngine - Your DSA Companion is created
          {" "}
        </p>
        <div
      ...
      <div className="home__skill">
        <div>
          <p>
            ...
            AlgoEngine -  At
            AlgoEngine, you get access to a powerful DSA search engine, tons of
            resources and many more. AlgoEngine is a perfect blend of reading
            ...
            new techniques while competing with peers. AlgoEngine is possible from
      ...
      <div className="home__contactContainer">
        <iframe
          title="home__map"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3781.269784054857!2d73.87251157372287!3d18.60693146653352!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c70090000001%3A0x160a20f3d0273495!2sArmy%20Institute%20of%20Technology!5e0!3m2!1sen!2sin!4v1742191360571!5m2!1sen!2sin"
